...
import { esc, getModelRunInfo } from "./utils.js?v=20260718083456";
import { agruparPorDia, resumenDia, tramos3h } from "./resumen.js?v=20260718083456";
import { iconoTiempo, flechaViento } from "./iconos.js?v=20260718083456";
...
function filaBloque(b) {
  ...
  return `
    <tr class="b6-fila ${claseRiesgo}">
      ...
      <td class="b6-col b6-termica">
        <span class="t-aire">${esc(valorTemp(b.tempRaw))}</span>
        <span class="t-sens">${esc(valorTemp(b.sensacionRaw))}</span>
      </td>
    </tr>`;
}
      ...
      <div class="b6-panel">
        ...
        <div class="b6-scroll">
          <table class="b6-tabla">
            <thead>
              <tr class="b6-header">
                <th>Horario</th><th></th><th>Visibilidad</th><th>Viento</th><th>T° / Sens.</th>
              </tr>
            </thead>
            <tbody>${bloques}</tbody>
          </table>
